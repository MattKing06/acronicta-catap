...
class LaserEnergyMeterPVMap(PVMap):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        LaserEnergyMeterPVMap.is_virtual = is_virtual
        LaserEnergyMeterPVMap.connect_on_creation = connect_on_creation
        super(
            LaserEnergyMeterPVMap,
            self,
        ).__init__(
...
class LaserEnergyMeterControlsInformation(ControlsInformation):
    """
    ...
    """
    pv_record_map: SerializeAsAny[LaserEnergyMeterPVMap]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        LaserEnergyMeterControlsInformation.is_virtual = is_virtual
        LaserEnergyMeterControlsInformation.connect_on_creation = connect_on_creation
        super(
            LaserEnergyMeterControlsInformation,
            self,
        ).__init__(
            is_virtual=is_virtual,
            connect_on_creation=connect_on_creation,
    ...
    @classmethod
    def validate_pv_map(cls, v: Any) -> LaserEnergyMeterPVMap:
        return LaserEnergyMeterPVMap(
...
class LaserEnergyMeterProperties(Properties):
    """
...
class LaserEnergyMeter(Hardware):
    """
    ...
    controls_information: SerializeAsAny[LaserEnergyMeterControlsInformation]
    """Controls information pertaining to this laserenergymeter
    (see :class:`~CATAP.common.machine.pv_utils.ControlsInformation`)"""
    properties: SerializeAsAny[LaserEnergyMeterProperties]
    ...
    @classmethod
    def validate_controls_information(cls, v: Any) -> LaserEnergyMeterControlsInformation:
        try:
            return LaserEnergyMeterControlsInformation(
                is_virtual=cls.is_virtual,
                connect_on_creation=cls.connect_on_creation,
                **v,
            )
    ...
    @classmethod
    def validate_properties(cls, v: Any) -> LaserEnergyMeterProperties:
        try:
            return LaserEnergyMeterProperties(
                **v,
            )
        except Exception as e:
...
class LaserEnergyMeterFactory(Factory):
    """
    ...
    def __init__(
        ...
        super(LaserEnergyMeterFactory, self).__init__(
            is_virtual=is_virtual,
            hardware_type=LaserEnergyMeter,
            connect_on_creation=connect_on_creation,
            areas=areas,
        )

    def get_laserenergymeter(self, name: Union[str, List[str]] = None) -> LaserEnergyMeter:
        """
        ...
        :rtype: :class:`~CATAP.laser.components.laserenergymeter.LaserEnergyMeter`
        or Dict[str: :class:`~CATAP.laser.components.laserenergymeter.LaserEnergyMeter`]
        """
    ...
    def energyreadback(self, name: Union[str, List[str], None] = None):
        """
        Returns the 'energyreadback' property of the laserenergymeter(s).
    ...
    def overrange(self, name: Union[str, List[str], None] = None):
        """
        Returns the 'overrange' property of the laserenergymeter(s).
    ...
    def rangesp(self, name: Union[str, List[str], None] = None):
        """
        Returns the 'rangesp' property of the laserenergymeter(s).
    ...
    def runsp(self, name: Union[str, List[str], None] = None):
        """
        Returns the 'runsp' property of the laserenergymeter(s).
