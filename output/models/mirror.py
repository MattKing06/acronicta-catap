...
from CATAP.common.machine.pv_utils import ScalarPV
...
class MirrorPropertiesModel(Properties):
    ...
    @property
    def horizontal_channel(self):
        return self.horizontal_channel
    ...
    @property
    def vertical_channel(self):
        return self.vertical_channel
...
class MirrorFactoryModel(Factory):
    ...
    :class:`CATAP.laser.components.mirror.Mirror` objects.
